...
STATIC_URL = 'myStatics/'
STATIC_ROOT = BASE_DIR / 'myStatics'

MEDIA_URL = 'myMedia/'
MEDIA_ROOT = BASE_DIR / 'myMedia'
...
LOGIN_URL = '/login'       # we use the address path here. REMEMBER THE '/' SHOULD BE BEFORE THE PATH ADDRESS UNLIKE THE PATH ABOVE
